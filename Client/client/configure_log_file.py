...
def configure_log_file(playback_type="", client='c0', exp='err', log_file=config_dash.LOG_FILENAME):
    ...
    if log_file:
        log_filename = "_".join((log_file,playback_type,client, exp, strftime('%Y-%m-%d.%H_%M_%S.log')))
