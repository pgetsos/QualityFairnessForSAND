...
python3 ../Client/client/dash_client.py -m http://10.0.0.7:8006/bunny_2s/bbb_2s.mpd -p sand -c c1 -e 1clientSandqoe -f true
...
python3 ../Client/client/dash_client.py -m http://10.0.0.7:8006/bunny_2s/bbb_2s.mpd -p sand -c c1 -e 2clientsSyncSandqoe -f true
...
python3 ../Client/client/dash_client.py -m http://10.0.0.7:8006/bunny_2s/bbb_2s.mpd -p sand -c c1 -e 3clientsSyncSandqoe -f true
...
python3 ../Client/client/dash_client.py -m http://10.0.0.7:8006/bunny_2s/bbb_2s.mpd -p sand -c c1 -e 2clientsaSyncSandqoe -f true
...
python3 ../Client/client/dash_client.py -m http://10.0.0.7:8006/bunny_2s/bbb_2s.mpd -p sand -c c1 -e 3clientsaSyncSandqoe -f true

difference=$(($starting + 20*15*60 - $(date +%s)))
sleep $difference

python3 ../Client/client/dash_client.py -m http://10.0.0.7:8006/bunny_2s/bbb_2s.mpd -p sand -c c1 -e 1clientSandbanddiv

difference=$(($starting + 21*15*60 - $(date +%s)))
sleep $difference

python3 ../Client/client/dash_client.py -m http://10.0.0.7:8006/bunny_2s/bbb_2s.mpd -p sand -c c1 -e 2clientsSyncSandbanddiv

difference=$(($starting + 22*15*60 - $(date +%s)))
sleep $difference

python3 ../Client/client/dash_client.py -m http://10.0.0.7:8006/bunny_2s/bbb_2s.mpd -p sand -c c1 -e 3clientsSyncSandbanddiv

difference=$(($starting + 23*15*60 - $(date +%s)))
sleep $difference

python3 ../Client/client/dash_client.py -m http://10.0.0.7:8006/bunny_2s/bbb_2s.mpd -p sand -c c1 -e 2clientsASyncSandbanddiv

difference=$(($starting + 24*15*60 - $(date +%s)))
sleep $difference

python3 ../Client/client/dash_client.py -m http://10.0.0.7:8006/bunny_2s/bbb_2s.mpd -p sand -c c1 -e 3clientsASyncSandbanddiv
