...
python3 ../Client/client/dash_client.py -m http://10.0.0.7:8006/bunny_2s/bbb_2s.mpd -p basic -f true -c c3 -e 3clientsSyncbasic
...
python3 ../Client/client/dash_client.py -m http://10.0.0.7:8006/bunny_2s/bbb_2s.mpd -p basic -f true -c c3 -e 3clientsaSyncbasic
